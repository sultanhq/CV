...
I am a full stack Ruby Junior developer with a passion for understanding how things work from the ground up.
...
|---        |---         |---           |
| [The Cube](github.com/sultanhq/makers_cube) | The Cube is an art project to create a 6 sided LED cube which is interactive, decorative and customisable. | Linux, Python, Django, Javascript, WebSockets |
| [Twitter Forest](github.com/sultanhq/twitter_forest) | A forest that visually represents Twitter #'s as forest objects | Node.js, Javascript, HAML, WebSockets, Twitter Streaming API|
...
For a complete list, see my [Github](github.com/sultanhq).
...
### Fast Learner
For my one week project [(Twitter Forest)](github.com/sultanhq/twitter_forest)  at Makers Academy, our team found that our in-browser project required live communication with another service. I found that WebSockets was required, which I then learnt and implemented into production in under 2 days.
...
[Github: The Cube](github.com/sultanhq/makers_cube)
